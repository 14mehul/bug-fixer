<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="bugtracking.aspx.cs" Inherits="bugtracking" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <table>
    ...
    <tr>
    <td style="background-color: #ff9933;"><asp:Label ID="Label2" runat="server" Text="Assigned To" Font-Bold="True"></asp:Label></td>
